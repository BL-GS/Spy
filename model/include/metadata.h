...
namespace spy {
	...
	struct ModelMetaHeader {
		static constexpr size_t ModelMeta_MAGIC_SIZE = 4;
		using MagicArray = std::array<char, ModelMeta_MAGIC_SIZE>;

		static constexpr MagicArray ModelMeta_MAGIC{ 'G', 'G', 'U', 'F'};
		...
		constexpr ModelMetaHeader() : magic(ModelMeta_MAGIC), version(3), num_tensor(0), num_kv(0) {}
	};

	struct ModelMetaTensorInfo {
	...
	public:
		...
		static constexpr auto   ModelMeta_MAGIC        = ModelMetaHeader::ModelMeta_MAGIC;
