...
namespace spy {
    ...
    struct GraphBuilder {
		 ...
		 */
        static DataNode *create_constant_tensor(const GGUFContext &context, Graph &graph,
         ...
         */
        static DataNode *create_weight_tensor(const GGUFContext &context, Graph &graph,
                uint32_t dim, const Shape::DimensionArray &num_element, 
         ...
         */
        static DataNode *create_bias_tensor(const GGUFContext &context, Graph &graph,
                uint32_t dim, const Shape::DimensionArray &num_element, 
                TensorType tensor_type, int layer_idx = -1, int expert_id = -1) {
            return create_constant_tensor(context, graph, 
                dim, num_element,
