...
namespace spy {
    ...
    protected:
        std::unique_ptr<GGUFContext>    context_ptr_;
    ...
    public:
        explicit AbstractModel(std::unique_ptr<GGUFContext> &&context_ptr, const HyperParam &hyper_param):
        ...
        virtual void init_metadata() {
...

            {
                ...
                if (num_vocab_option.has_value()) {
                    ...
                    metadata_.num_vocab = context.find_gguf_value(LLMKey::TOKENIZER_LIST).get_value<GGUFArray>().size();
                }
            }
    ...
    public:
        ...
        GGUFContext &           get_context()   const { return *context_ptr_; }
